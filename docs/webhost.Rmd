...
```{r nhscls, echo=FALSE, message=FALSE, warning=FALSE, out.width="70%"}
...
Erin Matula: is graduating from [Northern Michigan University](https://nmu.edu/) with a bachelors degree in Environmental Science spring 2022 and will be going on to Trent University to study impacts of prescribed fire on boreal wetlands.  Erin was responsible for conceptualizing and implementing the dashboard, GIS analysis, data wrangling, chart making and writing. She completed this work as part of an internship with [The Nature Conservancy](https://www.nature.org/en-us/) and the [Conservation Data Lab](https://conservationdatalab.org/).
...
**Acknowledgements**
We would like to thank the [Vermont Chapter of The Nature Conservancy](https://www.nature.org/en-us/about-us/where-we-work/united-states/vermont/) for the inspiration, and Erin's mom for constant support. 
